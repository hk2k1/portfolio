...
export const projectsData = [
  ...
  },
  {
    ...
    description:
      "Developed a systematic program with detailed user interface. Collaborated with a team to produce a scheduling system that simulates a solution for bus bunching.",
